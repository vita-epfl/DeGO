# Acknowledgments: https://github.com/tarashakhurana/4d-occ-forecasting under MIT License
import math
import copy
import numpy as np
import torch
...
def main_rayiou(sem_pred_list, sem_gt_list, lidar_origin_list, occ_class_names):
    ...
    for sem_pred, sem_gt, lidar_origins in tqdm(zip(sem_pred_list, sem_gt_list, lidar_origin_list), ncols=50, total=len(sem_pred_list)):
    ...
    print("Done!")
    print("Starting to calculate metrics...", flush=True)
